...
exports.defaultErrMsg = void 0;
exports.defaultErrMsg = 'One or more of the required params was ' +
    'missing or invalid.';
function jetValidator(errCode, errMsg) {
    return (...params) => {
        const loopFns = getLoopFns(params);
        return (req, res, next) => {
            for (const loopFn of loopFns) {
                if (!loopFn(req)) {
                    return res
                        .status(errCode !== null && errCode !== void 0 ? errCode : 400)
                        .json({ error: (errMsg !== null && errMsg !== void 0 ? errMsg : exports.defaultErrMsg) });
                }
            }
            return next();
        };
